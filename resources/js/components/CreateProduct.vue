            ...
            <div class="col-md-6">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body border">
                        <vue-dropzone ref="myVueDropzone" id="dropzone" :options="dropzoneOptions" v-on:vdropzone-sending="sendingEvent" v-on:vdropzone-success="uploadSuccess" v-on:vdropzone-error="fail"></vue-dropzone>
                    </div>
                </div>
            </div>
    ...
    data() {
        return {
            ...
            dropzoneOptions: {
                ...
                //     console.log(message);
                //    // self.$toast.success(message,"Success");
                // }
            }
        }
    },
